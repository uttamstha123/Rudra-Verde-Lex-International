...
export const Contact = () => {
  ...
  return (
    <div data-testid="contact-page" className="section-neutral">
      {/* Header */}
      <section
        ref={headerRef}
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <h1 data-testid="contact-title" className="font-serif text-4xl sm:text-5xl lg:text-6xl text-navy-dark mb-6">
            Contact
          </h1>
          <p data-testid="contact-subtitle" className="text-lg text-charcoal max-w-2xl mx-auto">
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="mb-16">
            <p data-testid="contact-intro" className="text-charcoal leading-relaxed mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            {/* Office Location */}
            <div data-testid="contact-location" className="p-10 content-card border-l-4 border-accent">
            ...
            {/* Contact Details */}
            <div data-testid="contact-details" className="p-10 content-card border-l-4 border-divider">
              <h3 className="font-serif text-2xl text-navy-dark mb-8 tracking-wide">Contact Details</h3>
          ...
          {/* Important Notice */}
          <div data-testid="contact-notice" className="p-10 content-card border-l-4 border-accent">
      ...
      <section className="py-20 px-6 section-muted">
        <div className="max-w-4xl mx-auto">
          <h2 data-testid="additional-info-title" className="font-serif text-3xl text-navy-dark mb-8">
