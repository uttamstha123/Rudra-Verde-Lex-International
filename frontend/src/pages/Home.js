...
export const Home = () => {
  ...
  return (
    <div data-testid="home-page">
      ...
      <section
        ref={heroRef}
        className={`min-h-screen flex items-center justify-center px-6 py-32 bg-gradient-to-b from-white to-grey-50 transition-all duration-1000 ${
          heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
        }`}
      >
        <div className="max-w-4xl mx-auto text-center">
          <h1 data-testid="hero-title" className="font-serif text-5xl sm:text-6xl lg:text-7xl text-navy-dark mb-8 leading-tight tracking-wide">
      ...
      <section
        ref={introRef}
        className={`py-24 px-6 bg-white border-t border-divider transition-all duration-1000 delay-200 ${
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 text-gray-700 leading-relaxed bg-grey-50 p-10 border border-grey-200">
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <div className="w-16 h-0.5 bg-navy-dark mx-auto mb-6"></div>
            <h2 data-testid="areas-title" className="font-serif text-4xl sm:text-5xl text-navy-dark tracking-wide">
              Our Focus
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div data-testid="focus-area-1" className="bg-white p-10 border border-grey-300 card-hover">
              <h3 className="font-serif text-2xl text-navy-dark mb-5 tracking-wide">Professional Practice</h3>
            ...
            <div data-testid="focus-area-2" className="bg-white p-10 border border-grey-300 card-hover">
              <h3 className="font-serif text-2xl text-navy-dark mb-5 tracking-wide">Academic Contribution</h3>
              <div className="w-12 h-0.5 bg-grey-300 mb-5"></div>
              <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <div data-testid="focus-area-3" className="bg-white p-10 border border-grey-300 card-hover">
              <h3 className="font-serif text-2xl text-navy-dark mb-5 tracking-wide">Ethical Foundation</h3>
              <div className="w-12 h-0.5 bg-grey-300 mb-5"></div>
              <p className="text-gray-600 leading-relaxed text-sm">
      ...
      {/* Disclaimer Notice */}
      <section data-testid="home-disclaimer" className="py-20 px-6 bg-grey-200 border-t border-divider">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white p-10 border-l-4 border-navy-dark">
            <p className="text-sm text-gray-700 leading-relaxed">
              <strong className="text-navy-dark">Disclaimer:</strong> This website provides information for academic and professional purposes only.
