...
export const Home = () => {
  ...
  return (
    <div data-testid="home-page">
      ...
      <section
        ref={introRef}
        className={`py-24 px-6 bg-white hairline transition-all duration-1000 delay-200 ${
      ...
      <section
        ref={featuresRef}
        className={`py-24 px-6 section-muted hairline transition-all duration-1000 delay-300 ${
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div data-testid="focus-area-1" className="content-card-soft bg-white p-10 card-hover">
            ...
            <div data-testid="focus-area-2" className="content-card-soft bg-white p-10 card-hover">
            ...
            <div data-testid="focus-area-3" className="content-card-soft bg-white p-10 card-hover">
      ...
      {/* Disclaimer Notice */}
      <section data-testid="home-disclaimer" className="py-20 px-6 bg-grey-200 hairline">
        <div className="max-w-4xl mx-auto">
