...
export const Disclaimer = () => {
  ...
  return (
    <div data-testid="disclaimer-page" className="section-neutral">
      {/* Header */}
      <section
        ref={headerRef}
        className={`py-24 px-6 section-neutral transition-all duration-1000 ${
          headerVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
        }`}
      >
        <div className="max-w-4xl mx-auto text-center">
          <h1 data-testid="disclaimer-title" className="font-serif text-4xl sm:text-5xl lg:text-6xl text-navy-dark mb-6">
            Legal & Regulatory Disclaimer
          </h1>
          <p data-testid="disclaimer-subtitle" className="text-lg text-charcoal max-w-2xl mx-auto">
      ...
      >
        <div className="max-w-4xl mx-auto">
          {/* No Solicitation */}
          <div data-testid="disclaimer-section-1" className="mb-12 pb-12 border-b border-divider">
            <h2 className="font-serif text-2xl text-navy-dark mb-6">1. No Solicitation or Advertisement</h2>
          ...
          <div data-testid="disclaimer-section-2" className="mb-12 pb-12 border-b border-divider">
            <h2 className="font-serif text-2xl text-navy-dark mb-6">2. No Attorney-Client Relationship</h2>
            <div className="space-y-4 text-charcoal leading-relaxed">
              <p>
          ...
          {/* Not Legal Advice */}
          <div data-testid="disclaimer-section-3" className="mb-12 pb-12 border-b border-divider">
            <h2 className="font-serif text-2xl text-navy-dark mb-6">3. Not Legal Advice</h2>
            <div className="space-y-4 text-charcoal leading-relaxed">
              <p>
          ...
          <div data-testid="disclaimer-section-4" className="mb-12 pb-12 border-b border-divider">
            <h2 className="font-serif text-2xl text-navy-dark mb-6">4. Jurisdictional Limitations</h2>
            <div className="space-y-4 text-charcoal leading-relaxed">
              <p>
          ...
          {/* Academic Content */}
          <div data-testid="disclaimer-section-5" className="mb-12 pb-12 border-b border-divider">
            <h2 className="font-serif text-2xl text-navy-dark mb-6">5. Academic and Scholarly Content</h2>
            <div className="space-y-4 text-charcoal leading-relaxed">
              <p>
          ...
          <div data-testid="disclaimer-section-6" className="mb-12 pb-12 border-b border-divider">
            <h2 className="font-serif text-2xl text-navy-dark mb-6">6. Regulatory Compliance</h2>
            <div className="space-y-4 text-charcoal leading-relaxed">
              <p>
          ...
          <div data-testid="disclaimer-section-7" className="mb-12 pb-12 border-b border-divider">
            <h2 className="font-serif text-2xl text-navy-dark mb-6">7. Limitation of Liability</h2>
            <div className="space-y-4 text-charcoal leading-relaxed">
              <p>
          ...
          {/* External Links */}
          <div data-testid="disclaimer-section-8" className="mb-12 pb-12 border-b border-divider">
            <h2 className="font-serif text-2xl text-navy-dark mb-6">8. External Links and References</h2>
            <div className="space-y-4 text-charcoal leading-relaxed">
              <p>
          ...
          <div data-testid="disclaimer-section-9" className="mb-12">
            <h2 className="font-serif text-2xl text-navy-dark mb-6">9. Changes to This Disclaimer</h2>
            <div className="space-y-4 text-charcoal leading-relaxed">
              <p>
          ...
          <div data-testid="disclaimer-contact" className="p-8 content-card">
            <h3 className="font-serif text-xl text-navy-dark mb-4">Questions Regarding This Disclaimer</h3>
